...
<html style="background:white;">
 <head>
        <link rel="stylesheet" type="text/css" href="35Project.css">
		<meta charset="utf-8">
</head>
<header>
...
<h1 style="color:red; text-align:center; color:blue;">Maintenance Sign in</h1>
      <?php
	...
	if($connection){
	   ...
	   if($password!=""&&$email!=""){
	    ...
	    $query = "SELECT * FROM wrkorder.maintenance where Password = '$password' and UserName = '$email' ";
