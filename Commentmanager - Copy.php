             ...
             // $result = mysqli_query($connection,$query);
			  ...
			  //} manager_Id
			    $manager_Id = $_GET['manager_Id'];
			      echo $manager_Id;
			  $query = "SELECT * FROM wrkorder.manager where Manager_ID = $manager_Id ";
              $result = mysqli_query($connection,$query);
		      while($row=mysqli_fetch_assoc($result)){
			  ...
			  if($CommentAuthor==$FirstName&&$CommentAuthor!=""){
			   ...
			   $query = "INSERT INTO wrkorder.comment (Comment_Title, Comment_Author, Comment_Date, Comment_Content, wkorder_ID) 
                         VALUES('$CommentTitle', '$CommentAuthor', '$CommentDate', '$Comment_content', $wrkorder_Id )";
                         mysqli_query($connection,$query);
						 
						 //$query = "INSERT INTO wrkorder.worder (Manager_ID)
						 //VALUES($manager_Id) ";
						 //mysqli_query($connection, $query);
						 
              $query = "UPDATE wrkorder.worder SET Manager_ID = $manager_Id where wkorder_ID = '$wrkorder_Id'  ";
                          mysqli_query($connection, $query);                  
	 }
	 }
